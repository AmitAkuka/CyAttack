export const DATA_URL = "https://dashboard.mycloudconnection.com/attacks.json";
export const STORAGE_KEY = "ATTACKS_DATA";
export const MAX_DATA_LENGTH = 500;
export const MAX_ATTACK_RATE = 10;
export const MAP_CONFIG1 = {
  projectionConfig: {
    scale: 130,
  },
  width: 800,
